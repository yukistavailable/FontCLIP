...
class VisionTransformer(nn.Module):
    def __init__(
        ...
        self.return_each_resblock_output = return_each_resblock_output
        self.transformer = Transformer(width, layers, heads, return_each_resblock_output=self.return_each_resblock_output)
...
# add a dense layer to CLIP
class CLIP_Dense(nn.Module):
